...
#nullable enable
public class TouchStarDrop : TouchDrop
{
    public bool isDouble;

    private new SpriteRenderer[] fansRenderers = new SpriteRenderer[8];
    void Start()
    {
    ...
    {
        SetFanSprite(isDouble ? skinManager.TouchStar_Double : skinManager.TouchStar);
        fansRenderers[5].sprite = skinManager.TouchPoint;
        fansRenderers[6].sprite = skinManager.TouchBorder[0];
        fansRenderers[7].sprite = skinManager.TouchBorder[1];
        if (isEach)
        {
            SetFanSprite(isDouble ? skinManager.TouchStar_Each_Double : skinManager.TouchStar_Each);
            fansRenderers[5].sprite = skinManager.TouchPoint_Each;
            fansRenderers[6].sprite = skinManager.TouchBorder_Each[0];
            fansRenderers[7].sprite = skinManager.TouchBorder_Each[1];
        }
        if (isBreak)
        {
            SetFanSprite(isDouble ? skinManager.TouchStar_Break_Double : skinManager.TouchStar_Break);
            fansRenderers[5].sprite = skinManager.TouchPoint_Break;
            fansRenderers[6].sprite = skinManager.TouchBorder_Break[0];
            fansRenderers[7].sprite = skinManager.TouchBorder_Break[1];
        }
        if (isMine)
        {
            SetFanSprite(isDouble ? skinManager.TouchStar_Mine_Double : skinManager.TouchStar_Mine);
            fansRenderers[5].sprite = skinManager.TouchPoint_Mine;
            fansRenderers[6].sprite = skinManager.TouchBorder_Mine[0];
            fansRenderers[7].sprite = skinManager.TouchBorder_Mine[1];
        }
    ...
    {
        var angle = index * (Mathf.PI / 2.5f) + Mathf.PI;
    ...
    {
        for (var i = 0; i < 5; i++) fansRenderers[i].sprite = sprite;
    }
